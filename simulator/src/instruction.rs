		...
		match funct3 {
			...
			0b001 => match (imm >> 6) & 0x3f {
				...
				funct7 @ 0b011000 => match imm & 0x3f {
					...
					0b000100 => Self::SextB,
					0b000101 => Self::SextH,
					funct5 => todo!("invalid (funct3, funct7, funct5) for OP-IMM: (0b{funct3:03b}, 0b{:06b}, 0b{:06b})", funct7, funct5),
				},
				0b011010 => Self::Binvi,
				funct7 => todo!("invalid (funct3, funct7) for OP-IMM: (0b{funct3:03b}, 0b{:06b})", funct7),
			},
			0b010 => Self::Slti,
			0b011 => Self::Sltiu,
			0b100 => Self::Xori,
			...
			0b110 => Self::Ori,
			0b111 => Self::Andi,
			funct3 => todo!("invalid funct3 for OP-IMM: 0b{funct3:03b}"),
		}
	}
}
		...
		match funct3 {
			...
			0b001 => match (imm >> 5) & 0x7f {
				...
				funct7 @ 0b0110000 => match imm & 0x1f {
					...
					0b00001 => Self::Ctzw,
					0b00010 => Self::Cpopw,
					funct5 => todo!("invalid (funct3, funct7, funct5) for OP-IMM-32: (0b{funct3:03b}, 0b{:07b}, 0b{:05b})", funct7, funct5),
				},
				funct7 => todo!("invalid (funct3, funct7) for OP-IMM-32: (0b{funct3:03b}, 0b{:07b})", funct7),
			},
			...
			funct3 => todo!("invalid funct3 for OP-IMM-32: 0b{funct3:03b}"),
		}
	}
}
...
impl From<u8> for BranchOp {
	fn from(funct3: u8) -> Self {
		match funct3 {
			...
			funct3 => todo!("BranchOp::from(0x{funct3:02x})"),
		}
	}
}
