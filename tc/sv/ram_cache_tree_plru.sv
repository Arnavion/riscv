module ram_cache_tree_plru #(
	...
	ram_cache_tree_plru_inner #(.rv64(rv64)) ram_cache_tree_plru_inner_module (
		...
		cache_left_address_in_cache, cache_left_busy, cache_left_load_value,
		cache_left_address_in_cache, cache_right_busy, cache_right_load_value,
		oldest,
		address_in_cache,
		busy,
		load_value,
		cache_left_ram_input_load, cache_left_ram_input_store, cache_left_ram_input_flush,
		cache_right_ram_input_load, cache_right_ram_input_store, cache_right_ram_input_flush,
		next_oldest
	);
...
module test_ram_cache_tree_plru_inner;
	...
	ram_cache_tree_plru_inner #(.rv64(0)) ram_cache_tree_plru_inner_module (
		ram_input_load, ram_input_store, ram_input_flush,
		cache_left_address_in_cache, cache_left_busy, cache_left_load_value,
		cache_right_address_in_cache, cache_right_busy, cache_right_load_value,
		oldest,
		address_in_cache,
		busy,
		load_value,
	...
	`define test_case(
		ram_input_load_, ram_input_store_, ram_input_flush_,
		cache_left_address_in_cache_, cache_left_busy_, cache_left_load_value_,
		cache_right_address_in_cache_, cache_right_busy_, cache_right_load_value_,
		oldest_,
		expected_address_in_cache,
		expected_busy,
		expected_load_value,
		expected_cache_left_ram_input_load, expected_cache_left_ram_input_store, expected_cache_left_ram_input_flush,
		expected_cache_right_ram_input_load, expected_cache_right_ram_input_store, expected_cache_right_ram_input_flush,
		expected_next_oldest
	) begin \
