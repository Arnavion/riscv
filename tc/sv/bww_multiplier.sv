module bww_multiplier (
	...
	wire s36, c36;
	half_adder_plus_one adder36 (a[2] & b[7], a[3] & b[6], s36, c36);
	wire s37, c37;
	full_adder adder37 (a[4] & b[5], a[5] & b[4], a[6] & b[3], s37, c37);
	wire s38, c38;
	full_adder adder38 (a[7] & b[2], ~(a[1] & b[7] & b_is_signed), ~(a[7] & a_is_signed & b[1]), s38, c38);
	wire s39, c39;
	full_adder adder39 (s36, c28, c29, s39, c39);
	wire s40, c40;
	full_adder adder40 (c30, s37, s38, s40, c40);
	wire s41, c41;
	full_adder adder41 (c31, s39, c32, s41, c41);
	wire s42, c42;
	full_adder adder42 (s40, c33, s41, s42, c42);
	wire s43, c43;
	full_adder adder43 (s42, c34, c35, s43, c43);
	wire s44, c44;
	...
	wire s47, c47;
	full_adder adder47 (c38, s44, s45, s47, c47);
	wire s48, c48;
	full_adder adder48 (s46, c39, c40, s48, c48);
	wire s49, c49;
	full_adder adder49 (s47, c41, s48, s49, c49);
	wire s50, c50;
	full_adder adder50 (c42, s49, c43, s50, c50);
	wire s51, c51;
	...
	wire s54, c54;
	full_adder adder54 (c46, s52, c47, s54, c54);
	wire s55, c55;
	...
	wire s61, c61;
	full_adder adder61 (c55, s60, c56, s61, c61);
	wire s62, c62;
	...
	wire s69, c69;
	full_adder adder69 (a[7] & b[7] & b_is_signed, a[7] & a_is_signed & b[7], c66, s69, c69);
	wire s70, c70;
	full_adder adder70 (s69, c67, c68, s70, c70);
	assign {mulh, mul} = {
		s70,
		s68,
		s65,
...
module half_adder_plus_one (
	...
	assign {carry, sum} = {1'b0, a} + {1'b0, b} + 2'b01;
endmodule
...
module full_adder (
	...
	assign {carry, sum} = {1'b0, a} + {1'b0, b} + {1'b0, c};
endmodule
