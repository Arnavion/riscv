		...
		unique case (in[0+:2])
			...
			2'b01: unique case (in[13+:3])
				...
				3'b100: unique case (in[10+:2])
					// srli
					2'b00: `type_i(out, OpCode_OpImm, {2'b01, in[7+:3]}, 3'b101, {2'b01, in[7+:3]}, {6'b000000, in[12], in[2+:5]})

					// srai
					2'b01: `type_i(out, OpCode_OpImm, {2'b01, in[7+:3]}, 3'b101, {2'b01, in[7+:3]}, {6'b010000, in[12], in[2+:5]})

					// andi
					2'b10: `type_i(out, OpCode_OpImm, {2'b01, in[7+:3]}, 3'b111, {2'b01, in[7+:3]}, {{7{in[12]}}, in[2+:5]})

					2'b11: unique case ({in[12], in[5+:2]})
						// sub
						3'b000: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0100000)

						// xor
						3'b001: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b100, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0000000)

						// or
						3'b010: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b110, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0000000)

						// and
						3'b011: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b111, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0000000)
						...
						// mul
						3'b110: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0000001)
