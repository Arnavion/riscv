			...
			2'b01: unique case (in[13+:3])
				...
				3'b100: unique casez (in[10+:3])
					...
					3'b111: unique case (in[5+:2])
						...
						// mul
						2'b10: `type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 7'b0000001)
						...
						2'b11: unique case (in[2+:3])
							...
							// sext.b
							3'b001: `type_i(out, OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000100)

							// zext.h
							3'b010: if (rv64)
								`type_r(out, OpCode_Op32, {2'b01, in[7+:3]}, 3'b100, {2'b01, in[7+:3]}, 5'b00000, 7'b0000100)
							else
								`type_r(out, OpCode_Op, {2'b01, in[7+:3]}, 3'b100, {2'b01, in[7+:3]}, 5'b00000, 7'b0000100)

							// sext.h
							3'b011: `type_i(out, OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000101)
