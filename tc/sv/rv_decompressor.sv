	...
	always_comb begin
		...
		unique case (in[0+:2])
			2'b00: unique case (in[13+:3])
				...
				// flw
				3'b011: `type_i(out, OpCode_LoadFp, {2'b01, in[2+:3]}, 3'b010, {2'b01, in[7+:3]}, {5'b00000, in[5], in[10+:3], in[6], 2'b00})
				...
				// fsw
				3'b111: `type_s(out, OpCode_StoreFp, 3'b010, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {5'b00000, in[5], in[10+:3], in[6], 2'b00})
			endcase
			...
			2'b01: unique case (in[13+:3])
				...
				// jal
				3'b001: `type_j(out, OpCode_Jal, 5'b00001, {{10{in[12]}}, in[8], in[9+:2], in[6], in[7], in[2], in[11], in[3+:3]})
			...
			2'b10: unique case (in[13+:3])
				...
				// flwsp
				3'b011: `type_i(out, OpCode_LoadFp, in[7+:5], 3'b010, 5'b00010, {4'b0000, in[2+:2], in[12], in[4+:3], 2'b00})
				...
				// fswsp
				3'b111: `type_s(out, OpCode_StoreFp, 3'b010, 5'b00010, in[2+:5], {4'b0000, in[7+:2], in[9+:4], 2'b00})
			endcase
