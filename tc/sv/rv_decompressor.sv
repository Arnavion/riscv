		...
		unique case (in[0+:2])
			2'b00: unique case (in[13+:3])
				...
				3'b100: unique case (in[10+:3])
					// lbu
					3'b000: type_i(OpCode_Load, {2'b01, in[2+:3]}, 3'b100, {2'b01, in[7+:3]}, 12'({in[5], in[6]}));

					// lhu / lh
					3'b001: type_i(OpCode_Load, {2'b01, in[2+:3]}, {!in[6], 2'b01}, {2'b01, in[7+:3]}, 12'({in[5], 1'b0}));

					// sb
					3'b010: type_s(OpCode_Store, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 12'({in[5], in[6]}));

					// sh
					3'b011: type_s(OpCode_Store, 3'b001, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, 12'({in[5], 1'b0}));
