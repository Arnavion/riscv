		...
		unique case (in[0+:2])
			2'b00: unique case (in[13+:3])
				3'b000: if (in[2+:11] == '0) begin
					...
					// addi4spn
					`type_i(OpCode_OpImm, {2'b01, in[2+:3]}, 3'b000, 5'b00010, {2'b00, in[7+:4], in[11+:2], in[5], in[6], 2'b00})

				// fld
				3'b001: `type_i(OpCode_LoadFp, {2'b01, in[2+:3]}, 3'b011, {2'b01, in[7+:3]}, {4'b0000, in[5+:2], in[10+:3], 3'b000})

				// lw
				3'b010: `type_i(OpCode_Load, {2'b01, in[2+:3]}, 3'b010, {2'b01, in[7+:3]}, {5'b00000, in[5], in[10+:3], in[6], 2'b00})
				...
				3'b100: unique case (in[10+:3])
					// lbu
					3'b000: `type_i(OpCode_Load, {2'b01, in[2+:3]}, 3'b100, {2'b01, in[7+:3]}, {10'b0000000000, in[5], in[6]})

					// lhu / lh
					3'b001: `type_i(OpCode_Load, {2'b01, in[2+:3]}, {!in[6], 2'b01}, {2'b01, in[7+:3]}, {10'b0000000000, in[5], 1'b0})

					// sb
					3'b010: `type_s(OpCode_Store, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {10'b000000000, in[5], in[6]})

					// sh
					3'b011: `type_s(OpCode_Store, 3'b001, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {10'b0000000000, in[5], 1'b0})
				...
				// fsd
				3'b101: `type_s(OpCode_StoreFp, 3'b011, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {4'b0000, in[5+:2], in[10+:3], 3'b000})

				// sw
				3'b110: `type_s(OpCode_Store, 3'b010, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {5'b00000, in[5], in[10+:3], in[6], 2'b00})
			...
			2'b01: unique case (in[13+:3])
				// addi
				3'b000: `type_i(OpCode_OpImm, in[7+:5], 3'b000, in[7+:5], {{7{in[12]}}, in[2+:5]})
				...
				// li
				3'b010: `type_i(OpCode_OpImm, in[7+:5], 3'b000, 5'b00000, {{7{in[12]}}, in[2+:5]})

				3'b011: if (in[7+:5] == 5'b00010)
					// addi16sp
					`type_i(OpCode_OpImm, 5'b00010, 3'b000, 5'b00010, {{3{in[12]}}, in[3+:2], in[5], in[2], in[6], 4'b0000})
				else
					// lui
					`type_u(OpCode_Lui, in[7+:5], {{15{in[12]}}, in[2+:5]})
				...
				3'b100: unique case (in[10+:2])
					...
					// andi
					2'b10: `type_i(OpCode_OpImm, {2'b01, in[7+:3]}, 3'b111, {2'b01, in[7+:3]}, {{7{in[12]}}, in[2+:5]})
					...
					2'b11: unique case ({in[12], in[5+:2]})
						...
						3'b111: unique case (in[2+:3])
							...
							// sext.b
							3'b001: `type_i(OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000100)
							...
							// sext.h
							3'b011: `type_i(OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000101)
				...
				// j
				3'b101: `type_j(OpCode_Jal, 5'b00000, {{10{in[12]}}, in[8], in[9+:2], in[6], in[7], in[2], in[11], in[3+:3]})

				// beqz
				3'b110: `type_b(OpCode_Branch, 3'b000, {2'b01, in[7+:3]}, 5'b00000, {{5{in[12]}}, in[5+:2], in[2], in[10+:2], in[3+:2]})

				// bnez
				3'b111: `type_b(OpCode_Branch, 3'b001, {2'b01, in[7+:3]}, 5'b00000, {{5{in[12]}}, in[5+:2], in[2], in[10+:2], in[3+:2]})
			endcase
			...
			2'b10: unique case (in[13+:3])
				...
				// fldsp
				3'b001: `type_i(OpCode_LoadFp, in[7+:5], 3'b011, 5'b00010, {3'b000, in[2+:3], in[12], in[5+:2], 3'b000})

				// lwsp
				3'b010: `type_i(OpCode_Load, in[7+:5], 3'b010, 5'b00010, {4'b0000, in[2+:2], in[12], in[4+:3], 2'b00})
				...
				3'b100: unique case ({| in[7+:5], | in[2+:5]})
					...
					// jr, jalr
					2'b10: `type_i(OpCode_Jalr, {4'b0000, in[12]}, 3'b000, in[7+:5], 12'b000000000000)
				...
				// fsdsp
				3'b101: `type_s(OpCode_StoreFp, 3'b011, 5'b00010, in[2+:5], {3'b000, in[7+:3], in[10+:3], 3'b000})

				// swsp
				3'b110: `type_s(OpCode_Store, 3'b010, 5'b00010, in[2+:5], {4'b0000, in[7+:2], in[9+:4], 2'b00})
