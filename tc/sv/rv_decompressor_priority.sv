module rv_decompressor_priority #(
	...
	always_comb begin
		...
		priority casez (in[0+:16])
			...
			// lbu
			16'b100_000_???_??_???_00: `type_i(OpCode_Load, {2'b01, in[2+:3]}, 3'b100, {2'b01, in[7+:3]}, {10'b0000000000, in[5], in[6]})

			// lhu / lh
			16'b100_001_???_??_???_00: `type_i(OpCode_Load, {2'b01, in[2+:3]}, {!in[6], 2'b01}, {2'b01, in[7+:3]}, {10'b0000000000, in[5], 1'b0})

			// sb
			16'b100_010_???_??_???_00: `type_s(OpCode_Store, 3'b000, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {10'b000000000, in[5], in[6]})

			// sh
			16'b100_011_???_??_???_00: `type_s(OpCode_Store, 3'b001, {2'b01, in[7+:3]}, {2'b01, in[2+:3]}, {10'b0000000000, in[5], 1'b0})
			...
			// sext.b
			16'b100_1_11_???_11_001_01: `type_i(OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000100)

			// zext.h
			16'b100_1_11_???_11_010_01: if (rv64)
				`type_r(OpCode_Op32, {2'b01, in[7+:3]}, 3'b100, {2'b01, in[7+:3]}, 5'b00000, 7'b0000100)
			else
				`type_r(OpCode_Op, {2'b01, in[7+:3]}, 3'b100, {2'b01, in[7+:3]}, 5'b00000, 7'b0000100)

			// sext.h
			16'b100_1_11_???_11_011_01: `type_i(OpCode_OpImm, {2'b01, in[7+:3]}, 3'b001, {2'b01, in[7+:3]}, 12'b011000000101)
