...
module test_ram_cache #(
	...
	ram_cache #(.rv64(rv64), .ram_block_width(ram_block_width)) ram_cache_module (
		...
		fast_load_value,
		slow_busy, slow_load_value,

		inspect_cached_ram_block_address, inspect_state_is_dirty, inspect_state_is_writing, inspect_state_is_reading,
		busy,
		load_value,
		fast_store, fast_store_value,
		slow_load, slow_store, slow_address
	);
