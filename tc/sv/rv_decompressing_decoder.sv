		...
		if (in[0+:16] == '0) begin
			...
			unique casez ({in[0+:2], in[13+:3]})
				...
				5'b10001: begin
					...
					rs2_decoded = '0;
					imm = rv64 ?
						{55'b0, in[2+:3], in[12], in[5+:2], 3'b000} :
						{23'b0, in[2+:3], in[12], in[5+:2], 3'b000};
				end
				...
				5'b10011:
					if (rv64) begin
						...
						rs1_decoded = rs1_decoded_raw;
						rs2_decoded = '0;
						imm = {55'b0, in[2+:3], in[12], in[5+:2], 3'b000};
					end else begin
						// flwsp
						opcode = 5'b00001;
						funct3 = 3'b010;
				...
				5'b10101: begin
					...
					rs2_decoded = rs2_decoded_raw;
					imm = rv64 ?
						{55'b0, in[7+:3], in[10+:3], 3'b000} :
						{23'b0, in[7+:3], in[10+:3], 3'b000};
				end
				...
				5'b10110: begin
					...
					rs2_decoded = rs2_decoded_raw;
					imm = rv64 ?
						{56'b0, in[7+:2], in[9+:4], 2'b00} :
						{24'b0, in[7+:2], in[9+:4], 2'b00};
				end
				...
				5'b10111:
					if (rv64) begin
						...
						rs2 = in[2+:5];
						rs2_decoded = rs2_decoded_raw;
						imm = {55'b0, in[7+:3], in[10+:3], 3'b000};
					end else begin
						// fswsp
						opcode = 5'b01000;
						funct3 = 3'b010;
