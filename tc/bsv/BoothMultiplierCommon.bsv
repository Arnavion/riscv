...
module mkTestMultiplierModule#(Multiplier#(64) multiplier)();
	...
	function Stmt test_case_seq(TestCase test_case);
		return seq
	...
	let m <- mkTestModuleCases(make_test_cases, test_case_seq);
	return m;
endmodule
...
function Vector#(64, TestCase) make_test_cases;
	...
	function TestCase make_test_case(Vector#(8, Tuple2#(Int#(64), Int#(64))) pairs, Integer i);
	...
	return genWith(make_test_case(arrayToVector(pairs)));
endfunction
`endif
