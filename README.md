...
The `simulator/` directory contains a simulator with the same behavior and cycle timings as the in-game in-order emulator. It also contains an out-of-order implementation with multiple functional units and multiple branch speculation.
